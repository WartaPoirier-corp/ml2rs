...
# -*- coding: utf-8 -*-
#
# ml2rs documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    (master_doc, 'ml2rs.tex', 'ml2rs Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'ml2rs', 'ml2rs Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ml2rs', 'ml2rs Documentation',
     author, 'ml2rs', 'One line description of project.',
     'Miscellaneous'),
]
